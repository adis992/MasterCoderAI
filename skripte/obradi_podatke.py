...
RAW_PATHS = [
    "podaci/sirovi/github_sirovi.jsonl",
    "podaci/sirovi/bosanski_sirovi.jsonl",
    "podaci/sirovi/engleski_sirovi.jsonl",
]
PROCESSED_PATHS = [
    "podaci/obradeni/github_obradeni.jsonl",
    "podaci/obradeni/bosanski_obradeni.jsonl",
    "podaci/obradeni/engleski_obradeni.jsonl",
]
